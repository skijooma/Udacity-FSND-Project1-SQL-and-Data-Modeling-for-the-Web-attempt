...
// artistEditURLPattern = new RegExp(/^\/artists\/[0-9]+\/edit$/);
// venueEditURLPattern = new RegExp(/^\/venues\/[0-9]+\/edit$/);
//
// console.log("URL => ", request_url)
// console.log("Matched ?? * ", artistEditURLPattern.test(request_url))
//
...
// }
//
// /* Handling Artist edit form submission. */
// if (artistEditURLPattern.test(request_url)) {
// 	document.getElementById('artist-edit-form').onsubmit = function (e) {
// 		e.preventDefault();
// 		const formData = new FormData(document.getElementById('artist-edit-form'));
// 		const payload = {
// 			'name': document.getElementById('name').value,
// 			'city': document.getElementById('city').value,
// 			'state': document.getElementById('state').value,
...
// 		};
//
// 		console.log("We're here...........", payload, " - ", request_url)
//
// 		fetch(request_url, {
// 			method: 'POST',
// 			body: JSON.stringify(payload),
...
// 			.then(function (response) {
//
// 				console.log("Artist edit form response => ", response);
// 				return response.json();
// 			})
// 			.then(function (jsonResponse) {
//
// 				console.log("Artist edit form JSON response => ", jsonResponse);
//
// 				// TODO: Redirect to appropriate page
// 			})
// 			.catch(function () {
// 				document.getElementById('error').className = '';
// 				console.log("Error submitting artist edit form");
// 			})
// 	}
// }
